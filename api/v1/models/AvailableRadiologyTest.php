<?php
class AvailableRadiologyTest {
    private $conn;
    private $table = 'available_radiology_tests';
    ...
    // Read all available radiology tests
    ...
    // Create available radiology test
    ...
    // Update available radiology test
    ...
    // Delete available radiology test (soft delete)
