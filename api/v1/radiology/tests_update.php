...
if (
    ...
    if($radiology_test->update()) {
        http_response_code(200); // OK
        echo json_encode(
            array('message' => 'Radiology Test Updated')
        );
    } else {
        http_response_code(503); // Service Unavailable
        echo json_encode(
            array('message' => 'Radiology Test Not Updated')
        );
    }
} else {
    // Data is incomplete
    ...
    echo json_encode(
        array('message' => 'Radiology Test Not Updated. Incomplete data.')
    );
}
?>
